...
### Command line
`npm install @erboladaiorg/occaecati-inventore -g`
...
### As a node library
`npm install @erboladaiorg/occaecati-inventore`
...
```js
var PJV=require('@erboladaiorg/occaecati-inventore').PJV;
...
## Issues/Requests
Please check out [the existing issues](https://github.com/erboladaiorg/occaecati-inventore/issues), 
and if you don't see that your problem is already being worked on, 
please [file an issue](https://github.com/erboladaiorg/occaecati-inventore/issues/new).
...
## License
See [LICENSE](https://github.com/erboladaiorg/occaecati-inventore/blob/master/LICENSE)
